...
workro hr — startup, built the website for workro hr (workrohr.com) | infinitysols.com — freelance, built website | united airlines — consulting, recruiting & MileagePlus strategy | mindcord — startup, 130k+ STEM community | notabook.xyz — personal, project mgmt tool | figur8 — startup, 4th/2000 hackathon, AI consulting engine | planout.me — personal, AI voice/text notes companion | careshub — consulting, strategic planning | instasched — personal, when2meet+calendly alternative | psg consulting — consulting, Purdue student govt transparency | typeshit — personal, rich text editor (typeshitt.vercel.app)
